 ...
 */
export async function dbAddPlayer(roomId, token, socketId, username, role) {
    try {
 ...
 */
export async function dbSaveStroke(roundId, strokeOrder, color, size, points) {
    try {
 ...
 */
export async function dbGetRoundStrokes(roundId) {
    try {
